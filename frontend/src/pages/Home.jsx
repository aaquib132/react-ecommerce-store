      ...
      <main className="pt-24 pb-20">
          ...
          <div className="relative group rounded-[2.5rem] overflow-hidden bg-indigo-900 aspect-3/4 sm:aspect-video md:aspect-21/9 flex items-center">
            ...
            <div className="relative z-10 px-6 sm:px-8 md:px-20 max-w-2xl mt-12 sm:mt-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8 sm:mt-0">
                <Link
                  to="/products"
                  className="bg-white text-black px-6 py-3 sm:px-8 sm:py-4 rounded-full font-bold hover:bg-indigo-600 hover:text-white transition flex items-center justify-center text-sm sm:text-base"
                >
                  Shop Collection
                ...
                <button
                  ...
                  className="border-2 border-white/30 text-white backdrop-blur-md px-6 py-3 sm:px-8 sm:py-4 rounded-full font-bold hover:bg-white/10 transition text-sm sm:text-base"
                >
                  Watch Film
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-8 sm:mb-10">
            <div>
              <h2 className="text-2xl sm:text-3xl font-black mb-1 sm:mb-2">Trending Now</h2>
            ...
            <Link
              to="/products"
              className="flex items-center font-bold text-sm sm:text-base text-indigo-600 hover:text-indigo-700 whitespace-nowrap ml-4"
            >
              View All
