...
export default function OrderConfirm() {
  ...
  const downloadInvoice = () => {
    ...
    doc.text(`Customer: ${shippingData.firstName} ${shippingData.lastName}`, 20, 50);
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 sm:p-8 mb-8 sm:mb-10 overflow-x-auto">
          ...
          <div className="relative min-w-[500px] sm:min-w-0 px-4 sm:px-0">
            ...
            <div className="flex justify-between relative">
              ...
              <TimelineStep icon={<PackageCheck size={18} />} label="Confirmed" active />
              <TimelineStep icon={<PackageCheck size={18} />} label="Packed" active />
              <TimelineStep icon={<Truck size={18} />} label="Shipped" />
              <TimelineStep icon={<Truck size={18} />} label="Out for Delivery" />
